...
//@line 8 "e:\builds\moz2_slave\rel-m-rel-xr-w32-bld\build\xulrunner\setup\nsXULAppInstall.js"
...
AppInstall.prototype = {
  ...
  installApplication : function ai_IA(aAppFile, aDirectory, aLeafName) {
    ...
    if (aDirectory == null) {
//@line 202 "e:\builds\moz2_slave\rel-m-rel-xr-w32-bld\build\xulrunner\setup\nsXULAppInstall.js"
      aDirectory = getDirectoryKey("ProgF");
      if (vendor)
        aDirectory.append(vendor);
//@line 218 "e:\builds\moz2_slave\rel-m-rel-xr-w32-bld\build\xulrunner\setup\nsXULAppInstall.js"
    }
    else {
    ...
    if (aLeafName == "") {
//@line 232 "e:\builds\moz2_slave\rel-m-rel-xr-w32-bld\build\xulrunner\setup\nsXULAppInstall.js"
      aLeafName = appName;
//@line 237 "e:\builds\moz2_slave\rel-m-rel-xr-w32-bld\build\xulrunner\setup\nsXULAppInstall.js"
    }
...
//@line 308 "e:\builds\moz2_slave\rel-m-rel-xr-w32-bld\build\xulrunner\setup\nsXULAppInstall.js"
...
//@line 315 "e:\builds\moz2_slave\rel-m-rel-xr-w32-bld\build\xulrunner\setup\nsXULAppInstall.js"
  }
};
