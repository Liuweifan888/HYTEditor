...
let dataProviders = {
  ...
  graphics: function graphics(done) {
    ...
    if (!data.numAcceleratedWindows && gfxInfo) {
      let feature =
//@line 241 "e:\builds\moz2_slave\rel-m-rel-xr-w32-bld\build\toolkit\content\Troubleshoot.jsm"
        gfxInfo.FEATURE_DIRECT3D_9_LAYERS;
//@line 245 "e:\builds\moz2_slave\rel-m-rel-xr-w32-bld\build\toolkit\content\Troubleshoot.jsm"
    ...
    if (gl) {
      ...
      let feature =
//@line 315 "e:\builds\moz2_slave\rel-m-rel-xr-w32-bld\build\toolkit\content\Troubleshoot.jsm"
...
//@line 327 "e:\builds\moz2_slave\rel-m-rel-xr-w32-bld\build\toolkit\content\Troubleshoot.jsm"
