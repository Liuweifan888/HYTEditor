...
//@line 11 "e:\builds\moz2_slave\rel-m-rel-xr-w32-bld\build\toolkit\content\WindowDraggingUtils.jsm"
  if (!this.isPanel())
    this._elem.addEventListener("MozMouseHittest", this, false);
  else
//@line 15 "e:\builds\moz2_slave\rel-m-rel-xr-w32-bld\build\toolkit\content\WindowDraggingUtils.jsm"
...
//@line 58 "e:\builds\moz2_slave\rel-m-rel-xr-w32-bld\build\toolkit\content\WindowDraggingUtils.jsm"
    if (!isPanel) {
      if (this.shouldDrag(aEvent))
        aEvent.preventDefault();
      return;
    }
//@line 64 "e:\builds\moz2_slave\rel-m-rel-xr-w32-bld\build\toolkit\content\WindowDraggingUtils.jsm"
...
//@line 75 "e:\builds\moz2_slave\rel-m-rel-xr-w32-bld\build\toolkit\content\WindowDraggingUtils.jsm"
        if (isPanel) {
...
//@line 88 "e:\builds\moz2_slave\rel-m-rel-xr-w32-bld\build\toolkit\content\WindowDraggingUtils.jsm"
        break;
      case "mousemove":
